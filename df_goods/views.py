...
def index(request):
    ...
    meat = GoodsInfo.objects.filter(gtype__id=2).order_by("-id")[:4]
    meat2 = GoodsInfo.objects.filter(gtype__id=2).order_by("-gclick")[:4]
    egg = GoodsInfo.objects.filter(gtype__id=3).order_by("-id")[:4]
    egg2 = GoodsInfo.objects.filter(gtype__id=3).order_by("-gclick")[:4]
    ...
    frozen = GoodsInfo.objects.filter(gtype__id=2).order_by("-id")[:4]
    frozen2 = GoodsInfo.objects.filter(gtype__id=2).order_by("-gclick")[:4]
